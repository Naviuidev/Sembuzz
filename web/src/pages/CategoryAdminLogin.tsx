...
export const CategoryAdminLogin = () => {
  ...
  // Do NOT redirect when isAuthenticated is true on this page - that can use a stale/expired token
  // and cause immediate 401 and logout. Only redirect after explicit successful login below.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Defer navigation so localStorage and state are committed before dashboard mounts and fires API requests
      ...
      >
        <div style={{ width: '100%', maxWidth: '90%' }}>
          ...
          <p style={{
            ...
            Sign in to manage your category
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4 text-end">
              <a 
                href="/category-admin/forgot-password" 
                style={{ 
                  color: '#1a1f2e', 
                  textDecoration: 'none',
                  fontSize: '0.9rem'

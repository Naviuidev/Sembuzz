    ...
    <SubCategoryAdminLayout>
      <div className="mb-4">
        ...
        <p style={{
          ...
          Events approved by category admin — visible on the website for your school.
        </p>
      </div>
      ...
      <div className="card border-0 shadow-sm" style={{ borderRadius: '0px' }}>
        <div className="card-body p-4">
          {isLoading ? (
            ...
            <div className="text-center py-5">
              <i className="bi bi-check-circle" style={{ fontSize: '3rem', color: '#6c757d', marginBottom: '1rem' }} />
              ...
              <table className="table table-hover" style={{ marginBottom: 0 }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #dee2e6' }}>
                    ...
                    <th style={{ color: '#1a1f2e', fontWeight: '600', padding: '1rem', backgroundColor: '#f8f9fa' }}>Approved on</th>
                  ...
                  {approvedEvents.map((event) => (
                    <tr key={event.id} style={{ borderBottom: '1px solid #dee2e6' }}>
                      ...
                      <td style={{ padding: '1rem', verticalAlign: 'middle' }}>
                        <span className="badge bg-success" style={{ borderRadius: '0px' }}>Live on website</span>
                      </td>
                    </tr>
                  ))}
                </tbody>

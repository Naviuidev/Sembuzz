...
export const SchoolAdminForgotPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.post('/school-admin/auth/forgot-password/request-otp', { refNum });
      setSuccess(`OTP has been sent to ${response.data.email}`);
      setEmailMask(response.data.email);
      setTimeout(() => {
        navigate('/school-admin/forgot-password/verify-otp', { state: { refNum } });
      }, 2000);
    } catch (err: any) {
      ...
      >
        <div style={{ width: '100%', maxWidth: '90%' }}>
          ...
          <p style={{
            ...
            Enter your school reference number to receive an OTP
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="refNum" className="form-label" style={{
                fontWeight: '500',
                color: '#1a1f2e',
                marginBottom: '0.5rem'
              }}>
              ...
              <input
                ...
                required
                placeholder="Enter your school reference number"
                style={{
                  borderRadius: '0px',

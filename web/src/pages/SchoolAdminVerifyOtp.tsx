...
export const SchoolAdminVerifyOtp = () => {
  ...
  useEffect(() => {
    if (!refNum) {
      navigate('/school-admin/forgot-password', { replace: true });
    }
  }, [refNum, navigate]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/school-admin/auth/forgot-password/verify-otp', { refNum, otp });
      setSuccess('OTP verified successfully!');
      setTimeout(() => {
        navigate('/school-admin/forgot-password/reset', { state: { refNum, otp } });
      }, 1000);
    } catch (err: any) {
        ...
        <div style={{ width: '100%', maxWidth: '90%' }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-3">
              <a 
                href="/school-admin/forgot-password" 
                style={{ 
                  color: '#1a1f2e', 
                  textDecoration: 'none',
                  fontSize: '0.9rem'

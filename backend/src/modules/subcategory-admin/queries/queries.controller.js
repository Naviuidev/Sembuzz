...
exports.SubCategoryAdminQueriesController = void 0;
...
let SubCategoryAdminQueriesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('subcategory-admin/queries'), (0, common_1.UseGuards)(subcategory_admin_guard_1.SubCategoryAdminGuard)];
    ...
    let _createToSchoolAdmin_decorators;
    ...
    var SubCategoryAdminQueriesController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _create_decorators = [(0, common_1.Post)()];
            _listFromSchoolAdmins_decorators = [(0, common_1.Get)('from-school-admins')];
            _listFromCategoryAdmins_decorators = [(0, common_1.Get)('from-category-admins')];
            _createToSchoolAdmin_decorators = [(0, common_1.Post)('to-school-admin')];
            ...
            _replyToCategoryAdmin_decorators = [(0, common_1.Post)('from-category-admins/:id/reply')];
            _deleteFromSchoolAdmin_decorators = [(0, common_1.Delete)('from-school-admins/:id')];
            _deleteFromCategoryAdmin_decorators = [(0, common_1.Delete)('from-category-admins/:id')];
            ...
            __esDecorate(this, null, _createToSchoolAdmin_decorators, { kind: "method", name: "createToSchoolAdmin", static: false, private: false, access: { has: obj => "createToSchoolAdmin" in obj, get: obj => obj.createToSchoolAdmin }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            SubCategoryAdminQueriesController = _classThis = _classDescriptor.value;
        ...
        async createToSchoolAdmin(req, dto) {
        ...
        async replyToCategoryAdmin(id, req, body) {
        ...
        async uploadFile(file) {
            if (!file) {
                throw new common_1.BadRequestException('No file was uploaded. Attachment is optional — you can send your request without an attachment.');
            }
            return { url: `/uploads/subcategory-admin-query-attachments/${file.filename}` };
        }
    };
    return SubCategoryAdminQueriesController = _classThis;
})();
exports.SubCategoryAdminQueriesController = SubCategoryAdminQueriesController;

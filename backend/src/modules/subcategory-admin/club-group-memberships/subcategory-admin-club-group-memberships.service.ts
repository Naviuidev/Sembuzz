...
@Injectable()
export class SubCategoryAdminClubGroupMembershipsService {
  private readonly logger = new Logger(SubCategoryAdminClubGroupMembershipsService.name);
  ...
  async approve(membershipId: string, schoolId: string, subCategoryAdminId: string) {
  ...
  async ban(membershipId: string, schoolId: string, subCategoryAdminId: string) {

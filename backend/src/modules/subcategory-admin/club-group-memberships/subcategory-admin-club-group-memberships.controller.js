...
exports.SubCategoryAdminClubGroupMembershipsController = void 0;
const common_1 = require("@nestjs/common");
const subcategory_admin_guard_1 = require("../guards/subcategory-admin.guard");
let SubCategoryAdminClubGroupMembershipsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('subcategory-admin/club-group-memberships'), (0, common_1.UseGuards)(subcategory_admin_guard_1.SubCategoryAdminGuard)];
    ...
    let _ban_decorators;
    var SubCategoryAdminClubGroupMembershipsController = class {
        ...
        static {
            ...
            SubCategoryAdminClubGroupMembershipsController = _classThis = _classDescriptor.value;
        ...
        async list(req, status) {
            const s = (status === 'approved' || status === 'banned' ? status : 'pending');
    ...
    return SubCategoryAdminClubGroupMembershipsController = _classThis;
})();
exports.SubCategoryAdminClubGroupMembershipsController = SubCategoryAdminClubGroupMembershipsController;
//# sourceMappingURL=subcategory-admin-club-group-memberships.controller.js.map
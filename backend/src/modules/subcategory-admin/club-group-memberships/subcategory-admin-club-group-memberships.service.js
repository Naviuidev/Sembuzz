...
exports.SubCategoryAdminClubGroupMembershipsService = void 0;
const common_1 = require("@nestjs/common");
let SubCategoryAdminClubGroupMembershipsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var SubCategoryAdminClubGroupMembershipsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            SubCategoryAdminClubGroupMembershipsService = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        prisma;
        emailService;
        logger = new common_1.Logger(SubCategoryAdminClubGroupMembershipsService.name);
        ...
        async listForSchool(schoolId, status) {
            return this.prisma.clubGroupMembership.findMany({
                ...
                select: {
                    ...
                    reviewedBySubCategory: { select: { id: true, name: true, email: true } },
                },
            });
        }
        ...
        async approve(membershipId, schoolId, subCategoryAdminId) {
            ...
            const updated = await this.prisma.clubGroupMembership.update({
                ...
                data: {
                    status: 'approved',
                    reviewedBySubCategoryAdminId: subCategoryAdminId,
                    reviewedAt: new Date(),
                },
        ...
        async ban(membershipId, schoolId, subCategoryAdminId) {
    ...
    return SubCategoryAdminClubGroupMembershipsService = _classThis;
})();
exports.SubCategoryAdminClubGroupMembershipsService = SubCategoryAdminClubGroupMembershipsService;
//# sourceMappingURL=subcategory-admin-club-group-memberships.service.js.map
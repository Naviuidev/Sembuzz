...
exports.SubCategoryAdminAuthController = void 0;
const common_1 = require("@nestjs/common");
const subcategory_admin_guard_1 = require("../guards/subcategory-admin.guard");
let SubCategoryAdminAuthController = (() => {
    let _classDecorators = [(0, common_1.Controller)('subcategory-admin/auth')];
    ...
    var SubCategoryAdminAuthController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _login_decorators = [(0, common_1.Post)('login')];
            _changePassword_decorators = [(0, common_1.Post)('change-password'), (0, common_1.UseGuards)(subcategory_admin_guard_1.SubCategoryAdminGuard)];
            _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(subcategory_admin_guard_1.SubCategoryAdminGuard)];
            ...
            SubCategoryAdminAuthController = _classThis = _classDescriptor.value;
    ...
    return SubCategoryAdminAuthController = _classThis;
})();
exports.SubCategoryAdminAuthController = SubCategoryAdminAuthController;

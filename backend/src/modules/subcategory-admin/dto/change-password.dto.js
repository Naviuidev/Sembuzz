...
let ChangePasswordDto = (() => {
    ...
    return class ChangePasswordDto {
        static {
            ...
            _newPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MinLength)(8)];
            _confirmPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];

...
exports.CategoryAdminAuthController = void 0;
const common_1 = require("@nestjs/common");
const category_admin_guard_1 = require("../guards/category-admin.guard");
let CategoryAdminAuthController = (() => {
    let _classDecorators = [(0, common_1.Controller)('category-admin/auth')];
    ...
    var CategoryAdminAuthController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _login_decorators = [(0, common_1.Post)('login')];
            _changePassword_decorators = [(0, common_1.Post)('change-password'), (0, common_1.UseGuards)(category_admin_guard_1.CategoryAdminGuard)];
            _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(category_admin_guard_1.CategoryAdminGuard)];
            ...
            CategoryAdminAuthController = _classThis = _classDescriptor.value;
    ...
    return CategoryAdminAuthController = _classThis;
})();
exports.CategoryAdminAuthController = CategoryAdminAuthController;

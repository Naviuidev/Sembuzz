...
@Controller('category-admin/banner-ads')
@UseGuards(CategoryAdminGuard)
export class CategoryAdminBannerAdsController {
  constructor(private readonly bannerAdsService: CategoryAdminBannerAdsService) {}

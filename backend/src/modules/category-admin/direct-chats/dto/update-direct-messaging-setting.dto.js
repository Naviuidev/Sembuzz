...
exports.UpdateDirectMessagingSettingDto = void 0;
const class_validator_1 = require("class-validator");
let UpdateDirectMessagingSettingDto = (() => {
    let _isEnabled_decorators;
    let _isEnabled_initializers = [];
    let _isEnabled_extraInitializers = [];
    return class UpdateDirectMessagingSettingDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _isEnabled_decorators = [(0, class_validator_1.IsBoolean)()];
        ...
        constructor() {
            __runInitializers(this, _isEnabled_extraInitializers);
        }
    };
})();
exports.UpdateDirectMessagingSettingDto = UpdateDirectMessagingSettingDto;
//# sourceMappingURL=update-direct-messaging-setting.dto.js.map
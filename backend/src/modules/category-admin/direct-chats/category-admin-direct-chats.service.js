...
exports.CategoryAdminDirectChatsService = void 0;
const common_1 = require("@nestjs/common");
const direct_chat_util_1 = require("../../direct-chats/direct-chat.util");
let CategoryAdminDirectChatsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var CategoryAdminDirectChatsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CategoryAdminDirectChatsService = _classThis = _classDescriptor.value;
    ...
    return CategoryAdminDirectChatsService = _classThis;
})();
exports.CategoryAdminDirectChatsService = CategoryAdminDirectChatsService;
//# sourceMappingURL=category-admin-direct-chats.service.js.map
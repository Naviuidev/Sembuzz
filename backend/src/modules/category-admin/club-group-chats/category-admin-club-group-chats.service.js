...
exports.CategoryAdminClubGroupChatsService = void 0;
...
let CategoryAdminClubGroupChatsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var CategoryAdminClubGroupChatsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CategoryAdminClubGroupChatsService = _classThis = _classDescriptor.value;
        ...
        async sendMessage(groupChatId, schoolId, categoryAdminId, dto) {
            await this.getChatForSchool(groupChatId, schoolId);
    ...
    return CategoryAdminClubGroupChatsService = _classThis;
})();
exports.CategoryAdminClubGroupChatsService = CategoryAdminClubGroupChatsService;
//# sourceMappingURL=category-admin-club-group-chats.service.js.map
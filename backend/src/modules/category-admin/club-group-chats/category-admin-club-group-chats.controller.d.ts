...
export declare class CategoryAdminClubGroupChatsController {
    private readonly service;
    constructor(service: CategoryAdminClubGroupChatsService);
    list(req: {
        user: {
            schoolId: string;
        };
    ...
    }, id: string, dto: CategoryAdminSendClubGroupMessageDto): Promise<{
        categoryAdmin: {
            id: string;
            name: string;
        } | null;

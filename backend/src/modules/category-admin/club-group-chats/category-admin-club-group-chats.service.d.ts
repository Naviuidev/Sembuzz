...
export declare class CategoryAdminClubGroupChatsService {
    ...
    sendMessage(groupChatId: string, schoolId: string, categoryAdminId: string, dto: CategoryAdminSendClubGroupMessageDto): Promise<{
        categoryAdmin: {
            id: string;
            name: string;
        } | null;

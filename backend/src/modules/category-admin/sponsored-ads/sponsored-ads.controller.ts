...
@Controller('category-admin/sponsored-ads')
@UseGuards(CategoryAdminGuard)
export class CategoryAdminSponsoredAdsController {
  constructor(private readonly sponsoredAdsService: CategoryAdminSponsoredAdsService) {}

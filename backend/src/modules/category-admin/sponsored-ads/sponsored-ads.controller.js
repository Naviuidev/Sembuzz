...
exports.CategoryAdminSponsoredAdsController = void 0;
...
const SPONSORED_IMAGES_DIR = path.join(process.cwd(), 'uploads', 'category-admin-sponsored-ads');
let CategoryAdminSponsoredAdsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('category-admin/sponsored-ads'), (0, common_1.UseGuards)(category_admin_guard_1.CategoryAdminGuard)];
    ...
    var CategoryAdminSponsoredAdsController = class {
        ...
        static {
            ...
            CategoryAdminSponsoredAdsController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        sponsoredAdsService = __runInitializers(this, _instanceExtraInitializers);
        constructor(sponsoredAdsService) {
            this.sponsoredAdsService = sponsoredAdsService;
        }
        ...
        async list(req) {
            return this.sponsoredAdsService.listByCategoryAdmin(req.user.sub);
        }
        async getAnalytics(req, dateFrom, dateTo, sponsoredAdId) {
    ...
    return CategoryAdminSponsoredAdsController = _classThis;
})();
exports.CategoryAdminSponsoredAdsController = CategoryAdminSponsoredAdsController;
//# sourceMappingURL=sponsored-ads.controller.js.map
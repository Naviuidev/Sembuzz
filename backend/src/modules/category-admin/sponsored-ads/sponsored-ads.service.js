...
exports.CategoryAdminSponsoredAdsService = void 0;
const common_1 = require("@nestjs/common");
let CategoryAdminSponsoredAdsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var CategoryAdminSponsoredAdsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            CategoryAdminSponsoredAdsService = _classThis = _classDescriptor.value;
        ...
        async getScope(categoryAdminId) {
        ...
        async getAnalytics(categoryAdminId, dateFrom, dateTo, sponsoredAdId) {
        ...
        async updateSchedule(categoryAdminId, id, dto) {
    ...
    return CategoryAdminSponsoredAdsService = _classThis;
})();
exports.CategoryAdminSponsoredAdsService = CategoryAdminSponsoredAdsService;

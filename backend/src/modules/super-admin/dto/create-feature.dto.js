...
let CreateFeatureDto = (() => {
    ...
    return class CreateFeatureDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _code_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.Matches)(/^[A-Z_]+$/, { message: 'Code must be uppercase letters and underscores only' })];

...
let FeaturesController = (() => {
    let _classDecorators = [(0, common_1.Controller)('super-admin/features'), (0, common_1.UseGuards)(super_admin_guard_1.SuperAdminGuard)];
    ...
    var FeaturesController = class {
        ...
        static {
            ...
            FeaturesController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        featuresService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return FeaturesController = _classThis;
})();

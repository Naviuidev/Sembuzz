...
let AuthController = (() => {
    let _classDecorators = [(0, common_1.Controller)('super-admin/auth')];
    ...
    var AuthController = class {
        ...
        static {
            ...
            _logout_decorators = [(0, common_1.Post)('logout'), (0, common_1.UseGuards)(super_admin_guard_1.SuperAdminGuard)];
            _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(super_admin_guard_1.SuperAdminGuard)];

...
export class AdminActionItemsService {
  ...
  async forSchoolAdmin(schoolId: string): Promise<AdminActionItemsResponse> {
    const [
      pendingUsers,
      chatRequests,
      studentGroupRequests,
      clubGroupChatDeleteRequests,
      studentGroupDeleteRequests,
      categoryQueries,
      subcategoryQueries,
      userHelp,
      emailChangeRequests,
      ...
      this.prisma.studentChatGroupRequest.count({ where: { schoolId, status: 'pending' } }),
      this.prisma.clubGroupChatDeleteRequest.count({ where: { schoolId, status: 'pending' } }),
      this.prisma.studentChatGroupDeleteRequest.count({ where: { schoolId, status: 'pending' } }),
      ...
      this.prisma.adminEmailChangeRequest.count({
      ...
      this.latestCreatedAt(this.prisma.studentChatGroupRequest, { schoolId, status: 'pending' }),
      this.latestCreatedAt(this.prisma.clubGroupChatDeleteRequest, { schoolId, status: 'pending' }),
      this.latestCreatedAt(this.prisma.studentChatGroupDeleteRequest, { schoolId, status: 'pending' }),
      ...
      this.latestCreatedAt(this.prisma.adminEmailChangeRequest, {
        schoolId,
        status: { in: ['pending', 'pending_new_email_otp'] },
      }),
    ]);
    ...
    return this.buildResponse([
      ...
      {
        id: 'student-chat-group-requests',
        kind: 'student_chat_group_requests',
        title: 'Student group requests',
        summary: `${studentGroupRequests} student group request${studentGroupRequests === 1 ? '' : 's'} to review`,
        href: '/school-admin/privacy?tab=message-config',
        count: studentGroupRequests,
        createdAt: latestStudentGroup,
      },
      {
        id: 'club-group-chat-delete-requests',
        kind: 'club_group_chat_delete_requests',
        title: 'Group chat delete requests',
        summary: `${clubGroupChatDeleteRequests} group chat delete request${clubGroupChatDeleteRequests === 1 ? '' : 's'} to review`,
        href: '/school-admin/privacy?tab=message-config',
        count: clubGroupChatDeleteRequests,
        createdAt: latestClubDelete,
      },
      {
        id: 'student-chat-group-delete-requests',
        kind: 'student_chat_group_delete_requests',
        title: 'Student group delete requests',
        summary: `${studentGroupDeleteRequests} student group delete request${studentGroupDeleteRequests === 1 ? '' : 's'} to review`,
        href: '/school-admin/privacy?tab=message-config',
        count: studentGroupDeleteRequests,
        createdAt: latestStudentDelete,
      },
      {
      ...
      {
        id: 'admin-email-change-requests',
        kind: 'admin_email_change_requests',
        title: 'Admin email change requests',
        summary: `${emailChangeRequests} email change request${emailChangeRequests === 1 ? '' : 's'} to review`,
        href: '/school-admin/privacy',
        count: emailChangeRequests,
        createdAt: latestEmailChange,
      },
    ]);
  }

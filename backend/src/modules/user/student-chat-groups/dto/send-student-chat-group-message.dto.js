...
exports.SendStudentChatGroupMessageDto = void 0;
const class_validator_1 = require("class-validator");
let SendStudentChatGroupMessageDto = (() => {
    ...
    return class SendStudentChatGroupMessageDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _body_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(4000)];
            _attachmentUrl_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(1000)];
            _attachmentType_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _attachmentName_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(500)];
            _replyToMessageId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
...
exports.SendStudentChatGroupMessageDto = SendStudentChatGroupMessageDto;
//# sourceMappingURL=send-student-chat-group-message.dto.js.map
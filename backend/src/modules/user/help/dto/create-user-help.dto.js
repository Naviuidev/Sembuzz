...
exports.CreateUserHelpDto = void 0;
const class_validator_1 = require("class-validator");
let CreateUserHelpDto = (() => {
    let _message_decorators;
    let _message_initializers = [];
    let _message_extraInitializers = [];
    return class CreateUserHelpDto {
        static {
...
exports.CreateUserHelpDto = CreateUserHelpDto;
//# sourceMappingURL=create-user-help.dto.js.map
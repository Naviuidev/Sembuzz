...
exports.CreateScrapedEventSourceDto = void 0;
const class_validator_1 = require("class-validator");
let CreateScrapedEventSourceDto = (() => {
    ...
    return class CreateScrapedEventSourceDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(2)];
            _websiteUrl_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^https?:\/\/.+/i, { message: 'websiteUrl must start with http:// or https://' })];
...
exports.CreateScrapedEventSourceDto = CreateScrapedEventSourceDto;
//# sourceMappingURL=create-scraped-event-source.dto.js.map
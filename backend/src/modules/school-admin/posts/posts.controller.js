...
exports.SchoolAdminPostsController = void 0;
...
let SchoolAdminPostsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('school-admin/posts'), (0, common_1.UseGuards)(school_admin_guard_1.SchoolAdminGuard)];
    ...
    var SchoolAdminPostsController = class {
        ...
        static {
            ...
            SchoolAdminPostsController = _classThis = _classDescriptor.value;
    ...
    return SchoolAdminPostsController = _classThis;
})();
exports.SchoolAdminPostsController = SchoolAdminPostsController;

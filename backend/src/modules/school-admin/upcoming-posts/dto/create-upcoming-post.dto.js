...
exports.CreateUpcomingPostDto = void 0;
const class_validator_1 = require("class-validator");
let CreateUpcomingPostDto = (() => {
    ...
    return class CreateUpcomingPostDto {
        static {
            ...
            _scheduledDate_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsDateString)({}, { message: 'scheduledDate must be a valid ISO 8601 date string (e.g. YYYY-MM-DD).' })];
            _scheduledTo_decorators = [(0, class_validator_1.ValidateIf)((o) => !o.scheduledDate), (0, class_validator_1.IsDateString)({}, { message: 'scheduledTo must be a valid ISO 8601 date string (e.g. YYYY-MM-DD).' })];
        ...
        scheduledDate = (__runInitializers(this, _imageUrls_extraInitializers), __runInitializers(this, _scheduledDate_initializers, void 0));
        scheduledTo = (__runInitializers(this, _scheduledDate_extraInitializers), __runInitializers(this, _scheduledTo_initializers, void 0));
        constructor() {
            __runInitializers(this, _scheduledTo_extraInitializers);
        }
    };
})();
exports.CreateUpcomingPostDto = CreateUpcomingPostDto;
//# sourceMappingURL=create-upcoming-post.dto.js.map
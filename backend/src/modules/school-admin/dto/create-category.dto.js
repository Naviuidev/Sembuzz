...
let CreateCategoryDto = (() => {
    ...
    return class CreateCategoryDto {
        static {
            ...
            _subcategories_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.IsString)({ each: true }), (0, class_validator_1.IsOptional)()];
        ...
        subcategories = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _subcategories_initializers, void 0)); // Array of subcategory names (optional)
        constructor() {
            __runInitializers(this, _subcategories_extraInitializers);
        }
    };
})();

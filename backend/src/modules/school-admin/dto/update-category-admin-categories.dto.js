...
exports.UpdateCategoryAdminCategoriesDto = void 0;
const class_validator_1 = require("class-validator");
let UpdateCategoryAdminCategoriesDto = (() => {
    let _categoryIds_decorators;
    let _categoryIds_initializers = [];
    let _categoryIds_extraInitializers = [];
    return class UpdateCategoryAdminCategoriesDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _categoryIds_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.ArrayNotEmpty)(), (0, class_validator_1.IsString)({ each: true })];
...
exports.UpdateCategoryAdminCategoriesDto = UpdateCategoryAdminCategoriesDto;
//# sourceMappingURL=update-category-admin-categories.dto.js.map
...
exports.AdsAdminAuthService = void 0;
const common_1 = require("@nestjs/common");
const bcrypt = __importStar(require("bcrypt"));
const crypto = __importStar(require("crypto"));
let AdsAdminAuthService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var AdsAdminAuthService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AdsAdminAuthService = _classThis = _classDescriptor.value;
        ...
        async requestOtp(requestOtpDto) {
            ...
            if (!admin) {
                throw new common_1.NotFoundException('No ads admin found with this email address');
            }
    ...
    return AdsAdminAuthService = _classThis;
})();
exports.AdsAdminAuthService = AdsAdminAuthService;

...
exports.AdsAdminAuthController = void 0;
const common_1 = require("@nestjs/common");
const ads_admin_guard_1 = require("../guards/ads-admin.guard");
let AdsAdminAuthController = (() => {
    let _classDecorators = [(0, common_1.Controller)('ads-admin/auth')];
    ...
    var AdsAdminAuthController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _login_decorators = [(0, common_1.Post)('login')];
            _changePassword_decorators = [(0, common_1.Post)('change-password'), (0, common_1.UseGuards)(ads_admin_guard_1.AdsAdminGuard)];
            _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(ads_admin_guard_1.AdsAdminGuard)];
            ...
            AdsAdminAuthController = _classThis = _classDescriptor.value;
    ...
    return AdsAdminAuthController = _classThis;
})();
exports.AdsAdminAuthController = AdsAdminAuthController;

...
exports.AdsAdminSponsoredAdsController = void 0;
const common_1 = require("@nestjs/common");
const platform_express_1 = require("@nestjs/platform-express");
const multer = __importStar(require("multer"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs"));
const ads_admin_guard_1 = require("../guards/ads-admin.guard");
const MAX_SIZE = 5 * 1024 * 1024; // 5MB
const ALLOWED_MIMES = ['image/jpeg', 'image/png', 'image/gif', 'image/webp'];
const SPONSORED_IMAGES_DIR = path.join(process.cwd(), 'uploads', 'ads-admin-sponsored-ads');
let AdsAdminSponsoredAdsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('ads-admin/sponsored-ads'), (0, common_1.UseGuards)(ads_admin_guard_1.AdsAdminGuard)];
    ...
    var AdsAdminSponsoredAdsController = class {
        ...
        static {
            ...
            AdsAdminSponsoredAdsController = _classThis = _classDescriptor.value;
    ...
    return AdsAdminSponsoredAdsController = _classThis;
})();
exports.AdsAdminSponsoredAdsController = AdsAdminSponsoredAdsController;

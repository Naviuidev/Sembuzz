...
exports.AdsAdminBannerAdsService = void 0;
const common_1 = require("@nestjs/common");
let AdsAdminBannerAdsService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var AdsAdminBannerAdsService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            AdsAdminBannerAdsService = _classThis = _classDescriptor.value;
        ...
        async getAnalytics(adsAdminId, dateFrom, dateTo, bannerAdId) {
        ...
        async updateSchedule(adsAdminId, bannerAdId, dto) {
        ...
        async endNow(adsAdminId, bannerAdId) {
            const ad = await this.client.bannerAd.findFirst({
                where: { id: bannerAdId, adsAdminId },
            });
            if (!ad)
        ...
        async remove(adsAdminId, bannerAdId) {
            const ad = await this.client.bannerAd.findFirst({
                where: { id: bannerAdId, adsAdminId },
            });
            if (!ad)
    ...
    return AdsAdminBannerAdsService = _classThis;
})();
exports.AdsAdminBannerAdsService = AdsAdminBannerAdsService;

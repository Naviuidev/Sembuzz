...
exports.AdsAdminBannerAdsController = void 0;
...
let AdsAdminBannerAdsController = (() => {
    let _classDecorators = [(0, common_1.Controller)('ads-admin/banner-ads'), (0, common_1.UseGuards)(ads_admin_guard_1.AdsAdminGuard)];
    ...
    var AdsAdminBannerAdsController = class {
        ...
        static {
            ...
            AdsAdminBannerAdsController = _classThis = _classDescriptor.value;
    ...
    return AdsAdminBannerAdsController = _classThis;
})();
exports.AdsAdminBannerAdsController = AdsAdminBannerAdsController;

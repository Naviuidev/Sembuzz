 ...
 * `prisma.superAdmin`: Exposes CRUD operations for the **SuperAdmin** model.
  ...
  */
    ...
    /**
     * `prisma.schoolFeature`: Exposes CRUD operations for the **SchoolFeature** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more SchoolFeatures
      * const schoolFeatures = await prisma.schoolFeature.findMany()
      * ```
      */
    get schoolFeature(): Prisma.SchoolFeatureDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
